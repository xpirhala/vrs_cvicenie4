...
#define		GPIO_BUTTON_MASK				(1 << GPIO_PIN_BUTTON)
//#define		PUSH_BUTTON_IT_FLAG				EXTI_PR_PIF4
#define 	GPIO_BUTTON_STATE				((!(GPIO_PORT_BUTTON->IDR & GPIO_BUTTON_MASK ))>0)

#define 	GPIO_PORT_LED					GPIOA
#define 	GPIO_PIN_LED					4
#define 	GPIO_LED_MAKS					(1 << GPIO_PIN_LED)
#define 	LED_ON							(GPIO_PORT_LED->BSRR |= GPIO_LED_MAKS);
#define 	LED_OFF							(GPIO_PORT_LED->BRR |= GPIO_LED_MAKS);
